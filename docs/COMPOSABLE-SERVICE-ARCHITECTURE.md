...
```yaml
# ~/ansai/ansible/service-catalog.yml
---
# Finance Services
actual_budget:
  name: actual-budget
...
5. **CLI Tools:** Simple commands (`ansai-service-add`, `ansai-deploy`)

### The Result

**Adding a service:**
```bash
ansai-service-add actual-budget && ansai-deploy
```
