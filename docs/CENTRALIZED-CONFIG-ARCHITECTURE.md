...
### Location
```
~/ansai/ansible/host_vars/miraclemax-config.yml
```
...
### Ansai Microservices (Centralized Config)
...
**Deployment:** 1 command (`ansai-deploy`)  
