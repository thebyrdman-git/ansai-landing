...
### Ansai App Development Framework
...
### `ansai-app-foundation` Repository (Public Template)

**Make this the gold standard:**

```markdown
# Ansai App Foundation - Gold Standard Template
...
```yaml
# ~/ansai/ansible/group_vars/services.yml
my_app:
...
```yaml
# ~/ansai/ansible/inventory/my-server.yml
services_enabled:
  - my_app
```
...
| Task | Traditional | Ansai Framework |
|------|-------------|---------------|
...
**Infrastructure:**
```bash
git clone ansai-ansible-framework  # Proven infrastructure
...
**Applications:**
```bash
git clone ansai-app-foundation     # Proven foundation
