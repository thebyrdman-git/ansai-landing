...
**Full Philosophy:** `~/ansai/docs/TOOL-DEVELOPMENT-PHILOSOPHY.md`  
**Ansible Guide:** `~/ansai/ansible/README.md`  
**Implementation:** `~/ansai/docs/ANSIBLE-IMPLEMENTATION-COMPLETE.md`  
**This Card:** `~/ansai/docs/GEERLING-QUICK-REFERENCE.md`
