...
- Single-command deployment (`ansai-service-add`)
...
| Tool | Purpose | From |
|------|---------|------|
| `ansai-dev-checklist` | Check before building | Philosophy |
...
|------|---------|--------------|
| `ansai-health-check` | Validate services | Kubernetes |
| `ansai-preflight` | Pre-deployment checks | Terraform |
| `ansai-rollback` | Automated rollback | Kubernetes |
| `ansai-backup` | Automated backups | AWS RDS |
| `ansai-chaos-test` | Resilience testing | Netflix |
| `ansai-postmortem` | Incident analysis | Google SRE |
...
| Tool | Purpose | Usage |
|------|---------|-------|
| `ansai-service-add` | Add service from catalog | `ansai-service-add actual-budget` |
| `ansai-service-list` | Show available blocks | `ansai-service-list` |
| `ansai-service-remove` | Remove service | `ansai-service-remove n8n` |
| `ansai-stack-add` | Deploy service stack | `ansai-stack-add monitoring` |
| `ansai-deploy` | Deploy all services | `ansai-deploy` |
...
```bash
ansai-dev-checklist "feature description"
```
...
| Aspect | Enterprise | Your Ansai Tools |
|--------|-----------|----------------|
...
- `bin/ansai-*` - Tool man pages (to create)
