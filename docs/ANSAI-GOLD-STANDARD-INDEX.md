# Ansai Gold Standard - Master Index
...
This index provides the complete roadmap for the Ansai (Ansai - AI Infrastructure) development philosophy. Every component, pattern, and practice documented here has been proven in production by industry leaders.
...
**Usage:**
```bash
ansai-dev-checklist "http client for REST APIs"
...
**Tools:**
- `bin/ansai-config-show` - Display central config
- `bin/ansai-config-edit` - Edit with backup
- `bin/ansai-config-validate` - YAML + schema validation
- `bin/ansai-config-diff` - Show changes
- `bin/ansai-config-export` - Export for environments
...
### Service Management
**Tools:**
- `bin/ansai-service-add` - Add new service (self-service)
- `bin/ansai-service-list` - Show all services
- `bin/ansai-service-remove` - Remove service
...
4. **Self-Service Portal** - Ansai service creation
...
### Example 3: Ansai App Foundation
**Pattern Application:**
...
```bash
ansai-dev-checklist "your feature"
```
...
- `repositories/ansai-*/` - Specialized modules
...
**Tools:**
- `bin/ansai-retrospect` - Create retrospections
- `bin/ansai-retrospect-analyze` - Find patterns
